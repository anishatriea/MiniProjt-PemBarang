...
unset($__errorArgs, $__bag); ?>" type="text" name="kodeBarang" id="kodeBarang" value="<?php echo e($errors->any() ? old('kodeBarang') : $barang->kodebarang); ?>" placeholder="Enter Kode Barang">
...
unset($__errorArgs, $__bag); ?>" type="text" name="namaBarang" id="namaBarang" value="<?php echo e($errors->any() ? old('namaBarang') : $barang->namabarang); ?>" placeholder="Enter Nama Barang">
...
unset($__errorArgs, $__bag); ?>" type="text" name="hargaBarang" id="hargaBarang" value="<?php echo e($errors->any() ? old('hargaBarang') : $barang->hargabarang); ?>" placeholder="Enter Harga Barang">
...
unset($__errorArgs, $__bag); ?>" type="text" name="deskripsiBarang" id="deskripsiBarang" value="<?php echo e($errors->any() ? old('deskripsiBarang') : $barang->deskripsibarang); ?>" placeholder="Enter Age">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <select name="satuan" id="satuan" class="form-select">
                                ...
                                <?php $__currentLoopData = $satuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($satuan->id); ?>" <?php echo e($selected == $satuan->id ? 'selected' : ''); ?>><?php echo e($satuan->kode.' - '.$satuan->nama); ?></option>
...
<?php /**PATH C:\UTSKU\resources\views/barang/edit.blade.php ENDPATH**/ ?>