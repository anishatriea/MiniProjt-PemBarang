...
<body>
    ...
    <nav>
        <div class="wrapper">
            ...
            <div class="menu">
                <ul>
                    <li><a href="<?php echo e(route('barang.index')); ?>" class="tbl-biru">List Barang</a></li>
                </ul>
    </nav>
...
unset($__errorArgs, $__bag); ?>" type="text" name="namaBarang" id="namaBarang" value="<?php echo e(old('namaBarang')); ?>" placeholder="Enter Nama Barang">
...
unset($__errorArgs, $__bag); ?>" type="text" name="kodeBarang" id="kodeBarang" value="<?php echo e(old('kodeBarang')); ?>" placeholder="Enter kode Barang">
...
unset($__errorArgs, $__bag); ?>" type="text" name="hargaBarang" id="hargaBarang" value="<?php echo e(old('hargaBarang')); ?>" placeholder="Enter Harga Barang">
...
unset($__errorArgs, $__bag); ?>" type="text" name="deskripsiBarang" id="deskripsiBarang" value="<?php echo e(old('deskripsiBarang')); ?>" placeholder="Enter Deskripsi Barang">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <select name="satuan" id="satuan" class="form-select">
                                <?php $__currentLoopData = $satuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($satuan->id); ?>" <?php echo e(old('satuan') == $satuan->id ? 'selected' : ''); ?>><?php echo e($satuan->kode.' - '.$satuan->nama); ?></option>
...
<?php /**PATH C:\Users\LENOVO\masterBarangUTS\resources\views/barang/create.blade.php ENDPATH**/ ?>